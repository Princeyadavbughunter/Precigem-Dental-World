      ...
      <div className="text-center max-w-6xl mx-auto md:flex md:items-center md:justify-between md:text-left">
        <div className="md:flex md:items-center md:gap-8">
          ...
          <a
            ...
            className="text-sm text-gray-700 mb-4 md:mb-0 hover:text-[#1a897f] transition-colors cursor-pointer block"
          >
            📍 Precigem Dental World
            301, Sai Iconic Tower, 4 Bungalows – Lokhandwala Road, Andheri West, Mumbai – 400053
          </a>
        </div>
        <div className="flex flex-col sm:flex-row gap-3 justify-center md:gap-4">
          ...
          <a href="tel:+918308411139" className="bg-brandBlue
