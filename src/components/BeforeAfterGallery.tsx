      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center bg-white p-6 md:p-8 rounded-xl shadow-lg mt-8">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Join hundreds of satisfied patients who have transformed their smiles with Dr. Mayur Khairnar &apos;s expertise. Book your consultation today and take the first step towards your dream smile.
          </p>
